...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <asp:TextBox ID="textboxEmail" runat="server" CssClass="form-control" placeholder="Email Address" />
    ...
    <asp:RequiredFieldValidator runat="server" ErrorMessage="An email address is required. " ControlToValidate="textboxEmail" CssClass="alert alert-warning" />
